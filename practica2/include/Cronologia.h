...
/**
  ...
  */
  ...
  /**
  * @brief Método de acceso al número de Fechas_Historicas de Cronologia
  * @return int con el valor del campo neventos
  */
...
/**
  ...
  * @return Devuelve un objeto de Cronología con las Fechas_Históricas, y por tanto eventos, que sucedieron entre los dos años
  */
  
  Cronologia buscarevento_entredosanios(int anio1,int anio2);
  ...
  * @pre 0<=i<getnumfechas()
  * @return Devuelve la referencia al elemento de forma que puede usarse para almacenar un valor en esa posición
  */
  
  Fecha_Historica & operator[](int i);

 /**
  * @brief Acceso a un elemento (Fecha_Histórica) de Cronología. El vector no se puede modificar, es acceso de solo lectura
  * @param i es la posición del vector de Cronología donde está el elemento
  * @pre 0<=i<getnumfechas()
  * @return Devuelve la referencia al elemento. 
  */
